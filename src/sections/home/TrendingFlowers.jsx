...
export default function TrendingFlowers() {
  ...
  return (
    <section
      style={{
        ...
        background: `linear-gradient(180deg, ${palette.offWhite || "#FEFCFA"} 0%, ${palette.cream} 100%)`,
      }}
    >
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        >
          <SectionTitle
            title="Trending Now"
            subtitle="Fresh arrivals and seasonal favourites"
            accent="trending"
